...
export const CAUSE_TOOLTIPS: Record<string, string> = {
    ...
    "Humanitarian": "Addresses acute suffering by providing essential resources like food, water, and shelter to those in immediate distress.",
    "Environment": "Reduces long-term suffering by preserving ecosystems that support all life, ensuring a habitable future.",
    "Education": "Mitigates chronic suffering caused by poverty and lack of opportunity, empowering individuals to break the cycle of hardship.",
    "Animals": "Alleviates pain and distress for sentient beings who cannot speak for themselves, focusing on welfare and protection.",
    "Healthcare": "Directly reduces physical pain and disease burden, improving quality of life and preventing premature death."
};
